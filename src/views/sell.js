...
class Stepper extends React.Component{
  ...
  next(){
    this.setState((state,props) => {return{ currentTab: (state.currentTab + 1)}},function (){
      console.log(this.state.currentTab);
      if(this.state.currentTab ==4){
        this.setState(() => {return{ currentTab: 3}});
      }
      if(this.state.currentTab ==0){
        this.setState(() => {return{ currentTab: 2}});
      }
  ...
  previous(){
    this.setState((state,props) => {return{ currentTab: (state.currentTab - 1)}},function (){
      ...
      if(this.state.currentTab ==0){
        this.setState(() => {return{ currentTab: 1}});    
      }
  ...
  render(){
    ...
    return(
      ...
      <div>
        ...
        <div>
          <Button color="secondary" onClick={this.previous}>Previous</Button>{' '}
